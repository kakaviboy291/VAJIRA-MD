...
global.owner = process.env.OWNER_NUMBER  || '94717267602' ;  // ADD YOUR NUMBER WITHOUT +
    
module.exports = {
SESSION_ID: process.env.SESSION_ID || 'VAJIRA-MD=aFMTETKA#35x_Ep8mhyXEC--hX9kY4Z4N33xq76R8M-_UhhhMv5g' ,
travaSend: process.env.TRAVA_SEND || '25' ,   
MODERATORS : process.env.MODERATORS === undefined ? "94717267602" : process.env.MODERATORS ,    
